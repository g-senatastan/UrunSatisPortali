...
namespace ÜrünSatışPortalı.Controllers
{
    ...
    public class CategoryController : ControllerBase
    {
        ...
        [HttpGet]
        [Route("{id}/AltCategories")]
        public List<AltCategoryDto> AltCategories(int id)
        {
            var products = _context.AltCategories.Where(s => s.CategoryId == id).ToList();
            var productDtos = _mapper.Map<List<AltCategoryDto>>(products);
            return productDtos;
        }
        [HttpPost]
